...
#MQTT Config
BROKER = "192.168.1.35"             #Broker IP
USE_MQTT_AUTH = False               #Set true, if user/pw authentification on broker, set false, if using anonymous login
...
#General Config
LOCATION = "Balzheim"            #Location of Judo device
NAME = "Judo-isoft"         #Name of Judo device
...
RUN_IN_APPDAEMON = False            #'True' , if running in Appdaemon docker directly in HA, on generic Linux platform set flag to 'False'
